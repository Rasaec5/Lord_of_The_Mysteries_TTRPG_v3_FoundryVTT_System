...
import { Attribute, Resource, DocumentLink, ProseMirror, RollVisualizer, Paperdoll, Calculator, TextField, DateTime, Tracker, MacroField, MeasuredTemplateField, ExtendedChoiceField, DiceField, DamageBonuses, DamageResistances, BooleanField, DieField, StringMethodField, NumberField, StringChoiceField, StringChoicesField, ParentPropertyReferenceField, SelfPropertyReferenceField, MoneyField, Inventory, DamageTrack, ImageField } from "./components/components.vue.es.mjs";
...
export default function VueRenderingMixin(BaseApplication) {
    ...
    class VueApplication extends BaseApplication {
        ...
        async _renderFrame(options) {
            ...
            this.vueApp.component("i-dice", DiceField);
            this.vueApp.component("i-bonuses", DamageBonuses);
            this.vueApp.component("i-resistances", DamageResistances);
            this.vueApp.component("i-boolean", BooleanField);
            this.vueApp.component("i-die", DieField);
            this.vueApp.component("i-string", StringMethodField);
            this.vueApp.component("i-number", NumberField);
            this.vueApp.component("i-string-choice", StringChoiceField);
            this.vueApp.component("i-string-choices", StringChoicesField);
            this.vueApp.component("i-parent-property-reference", ParentPropertyReferenceField);
            this.vueApp.component("i-self-property-reference", SelfPropertyReferenceField);
            this.vueApp.component("i-money", MoneyField);
            this.vueApp.component("i-inventory", Inventory);
            this.vueApp.component("i-damage-track", DamageTrack);
            this.vueApp.component("i-image", ImageField);
