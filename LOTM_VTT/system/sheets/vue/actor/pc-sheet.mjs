       ...
       import { PCActorApp } from "../components/components.vue.es.mjs";
       import LOTM_VTTRoll from "../../../rolls/roll.mjs";
       import LOTM_VTTDamageRoll from "../../../rolls/damage-roll.mjs";
       const { DOCUMENT_OWNERSHIP_LEVELS } = CONST;

       export default class PCVueSheet extends VueRenderingMixin(foundry.applications.sheets.ActorSheetV2) {
           ...
           vueParts = {
               "pc-actor-app": {
                   component: PCActorApp,
                   template: "<pc-actor-app :context=\"context\">Vue rendering for sheet failed.</pc-actor-app>"
               }
           };
           ...
           static DEFAULT_OPTIONS = {
               classes: ["LOTM_VTT", "sheet", "vue-sheet", "actor", "pc-sheet"],
