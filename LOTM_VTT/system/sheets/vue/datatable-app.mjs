       ...
       import { actorPCPCMyLootVuetifyDatatable } from "./components/components.vue.es.mjs";
       ...
       export default class DatatableApp extends VueRenderingMixin(foundry.applications.api.ApplicationV2) {
           ...
           _chooseComponent(table) {
               switch (table) {
                   case "actorPCPCMyLoot": return actorPCPCMyLootVuetifyDatatable; break;
           ...
           static DEFAULT_OPTIONS = {
               classes: ["LOTM_VTT", "dialog", "vue-sheet", "isdl-datatable"],
               position: {
                   width: 800,
                   height: 400,
               },
