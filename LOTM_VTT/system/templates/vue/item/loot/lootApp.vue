<script setup>
    ...
    import LootEffectsVuetifyDatatable from './components/datatables/lootEffectsVuetifyDatatable.vue';
    ...
    function spawnDatatableWindow(e, pageName, tabName) {
        if (event.button === 1) {
            ...
            const tableName = `itemLoot${pageName}${tabName}`;
...
<template>
    <v-app :style="userColorVars">
        ...
        <v-navigation-drawer v-model="drawer" temporary style="background-color: #dddddd">
            ...
            <v-tabs v-model="page" direction="vertical">
                <v-tab value="loot" prepend-icon="fa-solid fa-circle-user">Loot</v-tab>
            </v-tabs>
            <template v-slot:append>
                <div class="pa-2" >
        ...
        <v-main class="d-flex">
            <v-container :key="editModeRef" :class="pageBackground" fluid>
                <v-tabs-window v-model="page">
                    <v-tabs-window-item value="loot" data-tab="loot">
                        <v-row dense>
                            <i-number class="isdl-field isdl-number isdl-field-value isdl-visibility-default"
    :context="context"
    label="Loot.Value"
    icon=""
    systemPath="system.value"
    :hasValueParam="false"
    ...
    :disabled="isDisabled('value')" v-if="!isHidden('value')">
</i-number>
                        ...
                        <v-tabs v-model="tab" grow always-center>
                                ...
                                <v-tab value="effects" prepend-icon="fa-solid fa-sparkles" @mousedown="spawnDatatableWindow($event, 'Loot', 'effects')">Effects</v-tab>
                        </v-tabs>
